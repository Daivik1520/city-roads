  ...
  <div id="app">
    <div v-if='placeFound'>
      ...
      <div v-if='showSettings' class='print-window'>
        ...
        <h3>About</h3>
        <div>
          <p>This website was created by <b>DAIVIK REDDY</b>.
          It downloads roads from OpenStreetMap and renders them with WebGL.
          </p>
          <p>
           You can find the source code on <a href='https://github.com/Daivik1520/city-roads' target='_blank'>GitHub</a>.
           <br>
           Contact me at <a href='mailto:daivik1520@gmail.com'>daivik1520@gmail.com</a>
           <br>
           Follow me on Instagram <a href='https://instagram.com/daivik_warrior' target='_blank'>@daivik_warrior</a>
          </p>
        </div>
      </div>
    </div>
