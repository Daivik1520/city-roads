...
First, open [city roads](https://Daivik1520.github.io/city-roads/)
...
* `wayFilter` is used to filter out OpenStreetMap ways. You can find a list of well-known filters [here](https://github.com/Daivik1520/city-roads/blob/main/src/lib/Query.js). If you need 
